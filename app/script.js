            ...
            function handleTime() {
                ...
                if(timeLeft <= 0) {
                    ...
                    if(isSession) {
                        ...
                        timeLeft = timeLength;
                        document.getElementById('werk').currentTime = 0;
                        document.getElementById('werk').play();
                    } 
                    ...
                    // Break
                        ...
                        document.getElementById('rust').currentTime = 0;
                        document.getElementById('rust').play();
                    }
                    isSession = !isSession;
                } 
